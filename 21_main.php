...
<body>
    <div class="main">
        ...
        <section class="sec">
            ...
            <div class="btn">
                <button class="btn1"><a href="#">IEC Help & FAQ's</a></button>
                <button class="btn2"><a href="projectsignup.php">Apply for IEC</a></button>
            </div>
        </section>
    </div>
    <section class="ques1">
        ...
        <div class="ques3">
            ...
            <div class="discover"><button type="submit"><a href="6_trade.php">Discover</a></button></div>
        </div>
    </section>
