...
<?php
    ...
    $sql = "INSERT INTO `import_data` VALUES
    ...
    $sql2 = "INSERT INTO `total_table` VALUES('".$_POST['email']."','".$_POST['uname']."',".$_SESSION['uid'].",'".$_SESSION['utype']."','".$_SESSION['uname']."','import','".$_SESSION['price']."')";
